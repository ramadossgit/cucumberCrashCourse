...
public class LoginPageStepDef {
    ...
    public void i_am_on_the_open_cart_login_page(){
        driver.get("https://naveenautomationlabs.com/opencartindex.php?route=accountlogin");
    ...
    public void i_should_see_an_error_message_indicating(String errorMessage){
        Assert.assertEquals(driver.findElement(By.cssSelector(".alert.danger")).isDisplayed(),errorMessage);
    }
